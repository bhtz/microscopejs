var scaffoldingGenerator = module.exports = function () {
    ...
    // TODO refactoring file creation with modelname and property in params
    ...
    */
    self.generateIndexView = function (model) {
        if (model) {
    ...
    */
    self.generateDetailsView = function (model) {
        if (model) {
            self.createViewsDirectory(model.name, function () {
    ...
    */
    self.generateCreateView = function (model) {
        if (model) {
            self.createViewsDirectory(model.name, function () {
    ...
    */
    self.generateEditView = function (model) {
        if (model) {
            self.createViewsDirectory(model.name, function () {
    ...
    */
    self.generateDeleteView = function (model) {
        if (model) {
            self.createViewsDirectory(model.name, function () {
    ...
    */
    self.renderInputByProperty = function (modelname, property) {
        var input;
    ...
    */
    self.createViewsDirectory = function (dirname, next) {
